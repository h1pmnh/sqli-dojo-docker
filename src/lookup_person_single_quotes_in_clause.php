<?php include_once('common/common.php'); do_header("GET Parameter Injection with Single Quotes Surrounding in an IN Clause", "Traditional Forms"); ?>
...
if (isset($_GET['id'])) {
    ...
    if ($pdo !== null) {
        ...
        $query = "SELECT FIRST_NAME, LAST_NAME FROM PEOPLE WHERE id IN ('2','" . $id . "','4')";
